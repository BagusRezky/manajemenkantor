...
return new class extends Migration
{
    ...
    {
        Schema::create('imr_finishing_items', function (Blueprint $table) {
            $table->id();
            $table->foreignId('id_imr_finishing')->constrained('imr_finishings')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('imr_finishing_items');
    }
};
