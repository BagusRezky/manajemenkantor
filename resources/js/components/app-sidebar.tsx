...
export const dropdownNavItems: NavItemWithChildren[] = [
    ...
    },
    {
        ...
        children: [
            ...
            { title: 'Trans. Kas', icon: Banknote, href: '/trans-kas', permission: 'trans-kas.index' },
            ...
            { title: 'PO Bill Pay', icon: Banknote, href: '/transPayments', permission: 'transPayments.index' },
        ],
    },
    {
        title: 'HRD',
