// pages/pengajuanPinjaman/create.tsx
...
const breadcrumbs: BreadcrumbItem[] = [
    {
        ...
        href: route('pengajuanPinjamans.index'),
    },
    {
        title: 'Tambah Data',
        href: route('pengajuanPinjamans.create'),
    },
];
...
export default function CreatePengajuanPinjaman({ karyawans }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('pengajuanPinjamans.store'));
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Tambah Data Pengajuan Pinjaman" />
            <div className="mx-5 py-5">
                <Card>
                    <CardHeader>
                        <CardTitle>Tambah Data Pengajuan Pinjaman</CardTitle>
                    </CardHeader>
                    <CardContent>
                                        ...
                                        onChange={(date) => {
                                            if (date) {
                                                const formattedDate = new Date(date.getTime() - date.getTimezoneOffset() * 60000)
                                                    .toISOString()
                                                    .split('T')[0];
                                                setData('tanggal_pengajuan', formattedDate);
                                            } else {
