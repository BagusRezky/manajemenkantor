        ...
        <div>
            <div className="flex items-center justify-between py-4">
                <Input
                    ...
                    value={(table.getColumn('no_retur')?.getFilterValue() as string) ?? ''}
                    onChange={(event) => table.getColumn('no_retur')?.setFilterValue(event.target.value)}
                    className="max-w-sm"
                />
                <Link href={route('returEksternals.create')}>
                    <Button>Tambah Retur Eksternal</Button>
                </Link>
            </div>
