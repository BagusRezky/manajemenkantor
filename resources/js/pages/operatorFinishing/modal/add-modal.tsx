...
type OperatorFormData = Omit<OperatorFinishing, 'id'>;
...
export function OperatorFormModal() {
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
        ...
        const upperCaseFields = ['nama_operator_finishing'];
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post('/operatorFinishings', formData, {
            onSuccess: () => {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button variant="default">Add New Operator Finishing</Button>
            </DialogTrigger>
            <DialogContent className="sm:max-w-[425px]">
                <form onSubmit={handleSubmit}>
                    <DialogHeader>
                        <DialogTitle>Add New Operator Finishing</DialogTitle>
                        <DialogDescription>Fill in the Operator details and click save when you're done.</DialogDescription>
                    </DialogHeader>
                    <div className="grid gap-4 py-4">
                        <div className="grid grid-cols-4 items-center gap-4">
                            <Label htmlFor="nama_operator_finishing" className="text-right">
                                Nama Operator
                            </Label>
                            <Input
                                id="nama_operator_finishing"
                                name="nama_operator_finishing"
                                value={formData.nama_operator_finishing}
