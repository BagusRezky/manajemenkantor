...
export function DataTable<TData, TValue>({ columns, data }: DataTableProps<TData, TValue>) {
    ...
    const handleImport = (e: React.ChangeEvent<HTMLInputElement>) => {
            ...
            router.post(route('masterCoas.import'), formData, {
                onSuccess: () => {
                    e.target.value = '';
        ...
        <div>
            <div className="flex justify-between py-4">
                <Input
                    ...
                    value={(table.getColumn('nama_akun')?.getFilterValue() as string) ?? ''}
                    onChange={(e) => table.getColumn('nama_akun')?.setFilterValue(e.target.value)}
                    className="max-w-sm"
                />
                <div className="ml-auto flex space-x-3">
                    ...
                    <Link href={route('masterCoas.create')}>
                        <Button>Tambah Master COA</Button>
                    </Link>
                </div>
            </div>
