...
import { ImrFinishingFormData } from '@/types/imrFinishing';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Tambah IMR', href: '/imrFinishings/create' },
];
...
export default function CreateInternalMaterialRequest({ kartuInstruksiKerjas, nextNoImr }: Props) {
    ...
    const { data, setData, processing, errors, reset } = useForm<ImrFinishingFormData>({
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post('/imrFinishings', submitData, {
            onSuccess: (page) => {
                    ...
                    <CardContent>
                        <div onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="no_imr_finishing">No. IMR</Label>
                                    <Input id="no_imr_finishing" value={nextNoImr} disabled className="bg-gray-100 font-mono" />
