...
export default function ShowInternalMaterialRequest({ imrFinishing }: Props) {
                        ...
                        <CardContent>
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                                <div>
                                    ...
                                    <p className="mt-1 font-mono text-sm text-gray-900">{imrFinishing.no_imr_finishing}</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-gray-900">
                                        {imrFinishing.kartu_instruksi_kerja?.tgl_estimasi_selesai
                                            ? new Date(imrFinishing.kartu_instruksi_kerja.tgl_estimasi_selesai).toLocaleDateString('id-ID')
                                            : '-'}
                                    </p>
                                </div>
                                <div>
                                    <label className="text-sm font-medium text-gray-500">Dibuat Pada</label>
                                    <p className="mt-1 text-sm text-gray-900">{formatDate(imrFinishing.created_at)}</p>
                                </div>
                                <div>
                                    <label className="text-sm font-medium text-gray-500">Terakhir Update</label>
                                    <p className="mt-1 text-sm text-gray-900">{formatDate(imrFinishing.updated_at)}</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
