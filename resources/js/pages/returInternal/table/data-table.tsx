        ...
        <div>
            <div className="flex items-center justify-between py-4">
                <Input
                    ...
                    value={(table.getColumn('no_retur_internal')?.getFilterValue() as string) ?? ''}
                    onChange={(event) => table.getColumn('no_retur_internal')?.setFilterValue(event.target.value)}
                    className="max-w-sm"
                />
                <Link href={route('returInternals.create')}>
                    <Button>Tambah Retur Internal</Button>
                </Link>
            </div>
