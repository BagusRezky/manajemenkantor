                    ...
                    <CardContent className="mt-6">
                        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                            ...
                            <div className="space-y-1">
                                ...
                                <LabelValue label="Hasil Baik" value={`${dieMaking.hasil_baik_diemaking} Sheet`} />
                                <LabelValue label="Hasil Rusak" value={`${dieMaking.hasil_rusak_diemaking} Sheet`} />
                                <LabelValue label="Semi Waste" value={`${dieMaking.semi_waste_diemaking} Sheet`} />
